...
export const Profile = async ({ clientID }: ProfileProps) => {
  ...
  return (
    <section className="flex flex-col items-center justify-center gap-3 self-stretch border-b border-dashed border-neutral-separator-dark bg-neutral-aside-dark p-3 md:basis-1/2 md:border-b-0 md:border-r md:bg-neutral-aside-dark/70 md:backdrop-blur-md">
